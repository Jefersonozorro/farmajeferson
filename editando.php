<?php 
    ...
    $sql = $pdo->prepare("UPDATE usuario SET nomeMedicamento = :Nome do Medicamento, QTDMedicamento = :Quantidade do Medicamento, precound =:preço Unitario,  categoria =:categoria do Medicamento, validade =:Validade do Medicamento, validade=:Validade do Medicamento WHERE id = $id");
